...
def setup_mock_get(mocker, blockscout_abi_response, expected_params):
    get_patch = mocker.patch("ape_blockscout.client.requests")

    def get_mock_response(method, base_uri, params=None, *args, **kwargs):
        # Request will fail if made with incorrect parameters.
        assert method == "GET"
        assert base_uri == "https://blockscout.com/eth/mainnet/api"
        ...
        return blockscout_abi_response
...
@pytest.mark.parametrize(
    ...
    [
        ("ethereum", NETWORKS["ethereum"][0], "blockscout.com/eth/mainnet"),
        # ("ethereum-classic", NETWORKS["ethereum-classic"][0], "blockscout.com/etc/mainnet"),
        # ("xdai", NETWORKS["xdai"][0], "blockscout.com/xdai/mainnet"),
        # ("xdai", NETWORKS["xdai"][1], "blockscout.co/xdai/aox"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("ethereum", NETWORKS["ethereum"][0], "blockscout.com/eth/mainnet"),
        # ("ethereum-classic", f"{NETWORKS['ethereum-classic'][0]}", "blockscout.com/etc/mainnet"),
        # ("xdai", NETWORKS["xdai"][0], "blockscout.com/xdai/mainnet"),
        # ("xdai", NETWORKS["xdai"][1], "blockscout.co/xdai/aox"),
    ],
)
...
@pytest.mark.parametrize("network", ["mainnet"])
